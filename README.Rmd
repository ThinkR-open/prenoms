...
[![CRAN status](https://www.r-pkg.org/badges/version/prenoms)](https://cran.r-project.org/package=prenoms)
[![Codecov test coverage](https://codecov.io/gh/ThinkR-open/prenoms/branch/master/graph/badge.svg)](https://app.codecov.io/gh/ThinkR-open/prenoms?branch=master)
<!-- badges: end -->
